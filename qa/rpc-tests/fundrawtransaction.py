...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid helpforcancer address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid helpforcancer address" in e.error['message'])
        ...
        # send 12 HELPFORCANCER to msig addr
