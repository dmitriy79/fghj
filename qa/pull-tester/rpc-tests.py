...
#Set env vars
if "HELPFORCANCERD" not in os.environ:
    os.environ["HELPFORCANCERD"] = BUILDDIR + '/src/helpforcancerd' + EXEEXT
...
testScriptsExt = [
    ...
    # 'replace-by-fee.py', # RBF is disabled in Helpforcancer Core
]
