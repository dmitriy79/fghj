# Linearize
Construct a linear, no-fork, best version of the Helpforcancer blockchain. The scripts
...
JSON-RPC server. Running `helpforcancerd` or `helpforcancer-qt -server` will be sufficient.
...
* `input`: helpforcancerd blocks/ directory containing blkNNNNN.dat
