...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s helpforcancer-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  helpforcancer-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded helpforcancer transaction") + "\n" +
              "  helpforcancer-tx [options] -create [commands]   " + _("Create hex-encoded helpforcancer transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded helpforcancer transaction
