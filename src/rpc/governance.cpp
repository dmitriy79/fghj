...
//#define ENABLE_HELPFORCANCER_DEBUG
...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in helpforcancer.conf\n"
    ...
    /*
        ...
        gobject submit 6e622bb41bad1fb18e7f23ae96770aeb33129e18bd9efe790522488e580a0a03 0 1 1464292854 "beer-reimbursement" 
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("helpforcancer.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Helpforcancer features */
    { "helpforcancer",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "helpforcancer",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "helpforcancer",               "gobject",                &gobject,                true,  {} },
    { "helpforcancer",               "voteraw",                &voteraw,                true,  {} },
