...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Helpforcancer address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "helpforcancer",               "masternode",             &masternode,             true,  {} },
    { "helpforcancer",               "masternodelist",         &masternodelist,         true,  {} },
    { "helpforcancer",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "helpforcancer",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "helpforcancer",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "helpforcancer",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
