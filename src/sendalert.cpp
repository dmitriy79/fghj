...
2. run helpforcancerd with -printalert or -sendalert like this:
   /path/to/helpforcancerd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.helpforcancer.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Helpforcancer Core:0.12.0.58/"));
