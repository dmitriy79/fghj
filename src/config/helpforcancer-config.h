/* src/config/helpforcancer-config.h.  Generated from helpforcancer-config.h.in by configure.  */
/* src/config/helpforcancer-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HELPFORCANCER_CONFIG_H

#define HELPFORCANCER_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Helpforcancer Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Helpforcancer Core"
...
#define PACKAGE_BUGREPORT "https://github.com/helpforcancer/helpforcancer/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Helpforcancer Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Helpforcancer Core 1.4.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "helpforcancercore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://helpforcancer.com/"
