...
//! These need to be macros, as clientversion.cpp's and helpforcancer*-res.rc's voodoo requires it
...
/**
 * helpforcancerd-res.rc includes this file, but it cannot cope with real c++ code.
