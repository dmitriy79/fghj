...
Below are some notes on how to build Helpforcancer Core for Windows.
...
way. This will install to `c:\workspace\helpforcancer`, for example:

    make install DESTDIR=/mnt/c/workspace/helpforcancer
