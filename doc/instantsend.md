...
This mechanism has been integrated into Bitcore-Node-Helpforcancer which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/helpforcancer/insight-api-helpforcancer#web-socket-api](https://github.com/helpforcancer/insight-api-helpforcancer#web-socket-api)
* API: [https://github.com/helpforcancer/insight-api-helpforcancer#instantsend-transactions](https://github.com/helpforcancer/insight-api-helpforcancer#instantsend-transactions)
...
By default, the Helpforcancer Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Helpforcancer Core daemon:
